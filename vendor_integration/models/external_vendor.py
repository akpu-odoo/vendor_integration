...
class ExternalVendor(models.Model):
    """Supplier connection shared by one or more vendor API endpoints."""
    ...
    authentication_method_id = fields.Many2one(
    ...
    currency_id = fields.Many2one(
        related='partner_id.property_purchase_currency_id', readonly=False,
    )
    ...
    def create(self, vals_list):
        ...
        for vendor in vendors.filtered(lambda vendor: not vendor.partner_id):
